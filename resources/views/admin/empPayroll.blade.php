...
@section('content')
    ...
    <div class="container">
        <form method="post" action="{{route('emp_payroll.payslip', null,1 )}}" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success">Pay Slip</button><br>
        </form>
    </div>
    <div class="container">
        <div class="row">
                ...
                <div class="table-responsive-sm" style="overflow-x:auto; overflow-y:auto;">
                    ...
                    <table cellspacing="0" rules="all" border="1" id="Table1" style="border-collapse:collapse;" class="table table-hover table-bordered" >
                        <thead>
                            ...
                            <tr align='center'>
                                <th width="5%" align='center'><i class="fa fa-trash"></i></th>
                                ...
                                <th width="5%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="issue_date" style="cursor: pointer"> Issue Date <span id="issue_date_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
                                <th width="5%" align='center' class="sorting" data-sorting_type="{{$pageSetting['sort_type']}}" data-column_name="emp_display_id" style="cursor: pointer"> Emp. Display Id <span id="emp_display_id_sort_icon"><i class="fa fa-sort" aria-hidden="true"></i></span></th>
